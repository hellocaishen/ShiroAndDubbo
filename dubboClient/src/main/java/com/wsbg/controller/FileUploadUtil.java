...
public final class FileUploadUtil {  
	 ...
	 * @desc 上传音频
	 * **/
    public static JSONObject uploadListen(String httpurl, String fileName, InputStream inputStream) {  
        String result = "";  
        try {  
	 ...
	 * @desc 上传视频
	 * **/
    public static JSONObject uploadVideo(String httpurl, String fileName, InputStream inputStream) {  
        String result = "";  
        try {  
